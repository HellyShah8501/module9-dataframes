...
DetectHighest <- function(year) {
  year <- paste0("X",year)
  highest.year <- us.pe$category[us.pe[, year] == max(us.pe[, year])]
  return(highest.year)                              
}
